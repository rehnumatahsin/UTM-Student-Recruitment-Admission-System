...
<head>
  ...
  <title>UTM SMART Admission || Accepted Application</title>
          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Accepted Application
                </li>
...
<?php } if($row['AdminStatus']=="1"){ ?>                  <td><?php  echo "Accepted";?></td>
