...
data-open="click" data-menu="vertical-menu" data-col="1-column">
 ...
 <nav>
            <a href="#" class="logo">
                <img src="../images/logo - Copy.png" class="image1" width="320px" />
                
                <img src="../images/logo - Copy.png" class="image2" width="60px" height="60px" />
            </a>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0 pb-0">
                  <div class="card-title text-center">
                   <h4 style="font-weight: bold"> Student Sign Up</h4>
                  </div>
