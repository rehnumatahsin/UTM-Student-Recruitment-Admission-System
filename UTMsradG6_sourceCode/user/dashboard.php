...
<head>
  <title>Student Recruitment & Admission System</title>
...
<?php if($adsts==1) {?>
                      <h4 align="center">Your Application has been accepted</h4>
                    <?php } ?>
            ...
            <div class="card pull-up">
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h4 align="center">You have not applied for admission. Please submit an admission form.</h4>
                    </div>
                    <div>
         <i class="icon-file success font-large-2 float-right"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      ...
                      <h4 align="center">Your Application has been Approved. You will be notified through Email for further processing. Thank you.</h4>
