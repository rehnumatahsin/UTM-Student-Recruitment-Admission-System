...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"update tbladmapplications set CourseApplied='$coursename',FatherName='$fathername',MotherName='$mothername',DOB='$dob',Nationality='$nationality',Gender='$gender',Category='$category',CorrespondenceAdd='$coradd',PermanentAdd='$peradd',SecondaryBoard='$secboard',SecondaryBoardyop='$secyop',SecondaryBoardper='$secper',SSecondaryBoard='$ssecboard',SSecondaryBoardyop='$ssecyop',SSecondaryBoardper='$ssecper',GraUni='$grauni',GraUniyop='$grayop',GraUnidper='$graper',PGUni='$pguni',PGUniyop='$pgyop',PGUniper='$pgper',Signature='$sign' where ID='$eid' && UserId='$uid'");
...
<head>
  ...
  <title>UTM SMART || Admission Form</title>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Update Adimission Form</h4>
...
<td>   <input class="form-control white_bg" id="10thboard" name="10thboard" placeholder="Institution"  type="text" required='true' value="<?php echo $row['SecondaryBoard'];?>"></td>
...
<td>   <input class="form-control white_bg" id="12thboard" name="12thboard" placeholder="Institution"  type="text" required='true' value="<?php echo $row['SSecondaryBoard'];?>"></td>
...
<tr>
<th>Graduation</th>
<td>   <input class="form-control white_bg" id="graduation" name="graduation" placeholder="Institution"  type="text" value="<?php echo $row['GraUni'];?>"></td>
...
<td>   <input class="form-control white_bg" id="postgraduation" name="postgraduation" placeholder="Institution"  type="text" value="<?php echo $row['PGUni'];?>"></td>
